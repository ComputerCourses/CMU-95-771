...
public class ObjectNode {
    ...
    /**
     * Copy a list but will be recursive.
     *
     * @param source the head of a linked list that will be copied (which may be
     *               an empty list in where source is null)
     * @return The method has made a copy of the linked list starting at
     * source. The return value is the head reference for the
     * copy. The complexity of this method is O(n), where n is the length of the list.
     * @throws OutOfMemoryError Indicates that there is insufficient memory for the new list.
     **/
     ...
     * @param head the head reference for a linked list (which may be an empty list
     *             with a null head)
     * @return the number of nodes in the list with the given head.The
     * complexity of this method is O(n), where n is length of the list.
     * @note A wrong answer occurs for lists longer than Int.MAX_VALUE.
     **/
    ...
    public static void main(String[] args) {
        ...
        ObjectNode n = head;
        for (int i = 1; i < 26; i++) {
            n.addNodeAfter(new String(new byte[]{(byte) ('A' + i)}));
            n = n.link;
        }
        ...
        System.out.printf("Number of nodes in r = %d\n", listLength(r));
        System.out.printf("Number of nodes in r = %d\n", listLength_rec(r));
        ObjectNode r2 = listCopy_rec(head);
        System.out.println(r2);
        System.out.printf("Number of nodes in r2 = %d\n", listLength(r2));
        System.out.printf("Number of nodes in r2 = %d\n", listLength_rec(r2));
    }
}
